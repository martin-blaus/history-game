        ...
        <div className="max-w-sm w-full px-6 py-12 text-center">
          ...
          <div className="flex flex-col gap-2 mb-8">
            {events.map((ev, i) => (
              <div
                key={i}
                className="flex justify-between items-center px-4 py-3 bg-bg-card rounded-xl border border-border"
              >
                <span className="text-text-secondary text-sm text-left leading-snug flex-1 mr-3 line-clamp-1">
                  {ev.event}
                </span>
                <span
        ...
        {!confirmed ? (
          ...
          <div className="bg-bg-card rounded-2xl border border-border p-6 text-center">
            ...
            <div className="flex justify-center gap-6 mb-6 text-sm">
              <div>
                <div className="text-text-tertiary text-xs mb-0.5">
                  Tu respuesta
                </div>
